these Node.js Class Initialization
...
expire_at	String	Order expiry timestamp in epoch.. Create Order with Node.js SDK
...
token	String	Token used by the merchant UI. Check Order Status with Node.js SDK
...
details	Boolean	No	• true → Returns all payment attempt details under the paymentDetails list.
...
amount	Integer	Amount transferred using the above instrument and rail.. Initiate and Verify Refunds with Node.js SDK
