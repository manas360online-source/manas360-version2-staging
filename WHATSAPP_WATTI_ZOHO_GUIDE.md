...
### Report Uploaded Template

**Template:** `report_uploaded_patient`  
**Event:** Report/assessment document shared with patient  
**Variables:**
- `{{name}}`
- `{{therapistName}}`
- `{{reportName}}` - e.g., "PHQ-9 Assessment Report"
- `{{reportUrl}}`
...
Report: {{reportName}}
Prepared by: {{therapistName}}

View report: {{reportUrl}}

Discuss with your therapist in your next session.
```

---

### Prescription Issued Template

**Template:** `prescription_issued_patient`  
**Event:** Prescription created and shared  
**Variables:**
- `{{name}}`
- `{{therapistName}}`
- `{{prescriptionUrl}}`
...
Prescribed by: {{therapistName}}

Details: {{instructions}}

View full prescription: {{prescriptionUrl}}
...
### Therapist Note Shared Template

**Template:** `therapist_note_shared_patient`  
**Event:** Therapist shared session notes or documents  
**Variables:**
- `{{name}}`
- `{{therapistName}}`
- `{{noteTitle}}` - e.g., "Progress Notes - Apr 04, 2026"
- `{{noteUrl}}`

**Message Example:**
```
📝 {{therapistName}} shared notes with you!

Title: {{noteTitle}}

Read notes: {{noteUrl}}

These notes are confidential and for your reference.
```

---

### Therapist Message Template

**Template:** `therapist_message_patient`  
**Event:** Direct message/communication from therapist  
**Variables:**
- `{{name}}`
- `{{therapistName}}`
- `{{message}}` - e.g., "Keep up the great progress!"
- `{{messageUrl}}` - Link to full conversation

**Message Example:**
```
💬 {{therapistName}} sent you a message!
...
### Clinical Notes Updated Template

**Template:** `clinical_notes_updated_patient`  
**Event:** Therapist updated clinical notes  
**Variables:**
- `{{name}}`
- `{{therapistName}}`
- `{{notesSummary}}` - e.g., "Session focused on anxiety management techniques"
- `{{notesUrl}}`

**Message Example:**
```
📋 Clinical notes have been updated!

Updated by: {{therapistName}}

Summary: {{notesSummary}}

View details: {{notesUrl}}

Your care plan may have been adjusted. Check for updates.
```
...
3. 📄 Report uploaded → `report_uploaded`
4. 💊 Prescription issued → `prescription_issued`
5. 📝 Therapist shared notes → `therapist_note_shared`
6. 💬 Therapist sent message → `therapist_message`
7. 📋 Clinical notes updated → `clinical_notes_updated`
