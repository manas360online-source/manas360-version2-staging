        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border-l-[6px] border-blue-500">
            ...
            <ul className="space-y-4 text-sm font-medium">
              <li>
                <a href="/Certificate.pdf" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-blue-600 hover:text-blue-800 hover:underline transition-colors">
                  📄 5-Why Worksheet (PDF)
                </a>
              </li>
              <li>
