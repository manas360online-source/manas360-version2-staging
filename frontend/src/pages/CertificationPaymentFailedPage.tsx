...
export const PaymentFailedPage: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
            <SEO title="Payment Failed | MANAS360" />
            <div className="bg-white p-12 rounded-3xl shadow-xl max-w-lg w-full text-center animate-fade-in-up border border-slate-100">
                ...
                <p className="text-slate-600 mb-8">
                    We couldn't process your transaction for <span className="font-bold">{cert?.name || 'this certification'}</span>. This might be due to a network error or declined card (simulation).
                </p>
