-- DropForeignKey
ALTER TABLE "chat_analyses" DROP CONSTRAINT "chat_analyses_user_id_fkey";

-- DropForeignKey
ALTER TABLE "crisis_escalations" DROP CONSTRAINT "crisis_escalations_user_id_fkey";

-- DropForeignKey
ALTER TABLE "gad7_assessments" DROP CONSTRAINT "gad7_assessments_user_id_fkey";

-- DropForeignKey
ALTER TABLE "mood_logs" DROP CONSTRAINT "mood_logs_user_id_fkey";

-- DropForeignKey
ALTER TABLE "mood_predictions" DROP CONSTRAINT "mood_predictions_user_id_fkey";

-- DropForeignKey
ALTER TABLE "phq9_assessments" DROP CONSTRAINT "phq9_assessments_user_id_fkey";

-- DropForeignKey
ALTER TABLE "risk_scores" DROP CONSTRAINT "risk_scores_user_id_fkey";

-- DropIndex
DROP INDEX "mood_predictions_user_batch_idx";
...
-- AlterTable
ALTER TABLE "chat_analyses" ALTER COLUMN "created_at" SET DATA TYPE TIMESTAMP(3);

-- AlterTable
ALTER TABLE "crisis_escalations" ALTER COLUMN "ops_alerted_at" SET DATA TYPE TIMESTAMP(3),
...
-- AlterTable
ALTER TABLE "gad7_assessments" ALTER COLUMN "assessed_at" SET DATA TYPE TIMESTAMP(3),
ALTER COLUMN "created_at" SET DATA TYPE TIMESTAMP(3),
ALTER COLUMN "updated_at" DROP DEFAULT,
ALTER COLUMN "updated_at" SET DATA TYPE TIMESTAMP(3);

-- AlterTable
ALTER TABLE "mood_logs" ALTER COLUMN "logged_at" SET DATA TYPE TIMESTAMP(3),
ALTER COLUMN "created_at" SET DATA TYPE TIMESTAMP(3),
ALTER COLUMN "updated_at" DROP DEFAULT,
ALTER COLUMN "updated_at" SET DATA TYPE TIMESTAMP(3);

-- AlterTable
ALTER TABLE "mood_predictions" ALTER COLUMN "prediction_date" SET DATA TYPE TIMESTAMP(3),
ALTER COLUMN "created_at" SET DATA TYPE TIMESTAMP(3),
ALTER COLUMN "updated_at" DROP DEFAULT,
ALTER COLUMN "updated_at" SET DATA TYPE TIMESTAMP(3),
...
-- AlterTable
ALTER TABLE "patient_exercises" ALTER COLUMN "updatedAt" DROP DEFAULT;

-- AlterTable
ALTER TABLE "patient_payment_methods" ALTER COLUMN "updatedAt" DROP DEFAULT;

-- AlterTable
ALTER TABLE "patient_progress" ALTER COLUMN "updatedAt" DROP DEFAULT;

-- AlterTable
ALTER TABLE "patient_subscriptions" ALTER COLUMN "updatedAt" DROP DEFAULT;

-- AlterTable
ALTER TABLE "phq9_assessments" ALTER COLUMN "assessed_at" SET DATA TYPE TIMESTAMP(3),
ALTER COLUMN "created_at" SET DATA TYPE TIMESTAMP(3),
ALTER COLUMN "updated_at" DROP DEFAULT,
ALTER COLUMN "updated_at" SET DATA TYPE TIMESTAMP(3);

-- AlterTable
ALTER TABLE "risk_scores" ALTER COLUMN "evaluated_at" SET DATA TYPE TIMESTAMP(3),
ALTER COLUMN "created_at" SET DATA TYPE TIMESTAMP(3),
ALTER COLUMN "updated_at" DROP DEFAULT,
ALTER COLUMN "updated_at" SET DATA TYPE TIMESTAMP(3);
...
-- AlterTable
ALTER TABLE "therapist_cbt_modules" ALTER COLUMN "updated_at" DROP DEFAULT;
