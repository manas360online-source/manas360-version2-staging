/*
  ...
  - A unique constraint covering the columns `[therapy_session_id]` on the table `appointment_requests` will be added. If there are existing duplicate values, this will fail.
...
*/
-- CreateEnum
CREATE TYPE "CertificationPaymentPlan" AS ENUM ('FULL', 'INSTALLMENT');
...
ALTER TYPE "CertificationStatus" ADD VALUE 'PAID';
ALTER TYPE "CertificationStatus" ADD VALUE 'PARTIAL';
...
-- DropForeignKey
ALTER TABLE "appointment_requests" DROP CONSTRAINT "appointment_requests_therapy_session_id_fkey";
...
CREATE TABLE "certification_enrollments" (
    "id" TEXT NOT NULL,
    "userId" TEXT NOT NULL,
    "certificationSlug" TEXT NOT NULL,
    "status" "CertificationStatus" NOT NULL DEFAULT 'NONE',
    "paymentPlan" "CertificationPaymentPlan" NOT NULL DEFAULT 'FULL',
    "installmentsPaidCount" INTEGER NOT NULL DEFAULT 1,
    ...
    "certId" TEXT,
    "nextInstallmentDue" TIMESTAMP(3),
...
CREATE TABLE "retreat_intents" (
    ...
    CONSTRAINT "retreat_intents_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "certification_enrollments_userId_idx" ON "certification_enrollments"("userId");

-- CreateIndex
CREATE UNIQUE INDEX "certification_enrollments_userId_certificationSlug_key" ON "certification_enrollments"("userId", "certificationSlug");
...
-- CreateIndex
CREATE INDEX "retreat_intents_status_idx" ON "retreat_intents"("status");

-- CreateIndex
CREATE INDEX "retreat_intents_theme_idx" ON "retreat_intents"("theme");

-- CreateIndex
CREATE INDEX "retreat_intents_createdAt_idx" ON "retreat_intents"("createdAt");

-- CreateIndex
CREATE UNIQUE INDEX "appointment_requests_therapy_session_id_key" ON "appointment_requests"("therapy_session_id");
...
-- AddForeignKey
ALTER TABLE "certification_enrollments" ADD CONSTRAINT "certification_enrollments_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
