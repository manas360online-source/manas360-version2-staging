import{j as s}from"./vendor-DvrhTn1k.js";const i=`<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
`,d=()=>{const e=sessionStorage.getItem("journeyPhase")||"discovery",a=i.replace("showPhase('discovery')",`showPhase('${e}')`);return sessionStorage.removeItem("journeyPhase"),s.jsx("iframe",{srcDoc:a,title:"MANAS360 Certification Journey",style:{width:"100vw",height:"100vh",border:"none",display:"block"}})};export{d as default};
