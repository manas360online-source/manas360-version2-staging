...
router.get('/screening/templates', auth_middleware_1.requireAuth, (0, rbac_middleware_1.requireRole)('admin'), (0, rbac_middleware_1.requireAdminPolicy)('screening.manage'), (0, validate_middleware_1.asyncHandler)(free_screening_admin_controller_1.listScreeningTemplatesAdminController));
router.post('/screening/templates', auth_middleware_1.requireAuth, (0, rbac_middleware_1.requireRole)('admin'), (0, rbac_middleware_1.requireAdminPolicy)('screening.manage'), (0, validate_middleware_1.asyncHandler)(free_screening_admin_controller_1.createScreeningTemplateAdminController));
router.post('/screening/templates/defaults/:templateKey/ensure', auth_middleware_1.requireAuth, (0, rbac_middleware_1.requireRole)('admin'), (0, rbac_middleware_1.requireAdminPolicy)('screening.manage'), (0, validate_middleware_1.asyncHandler)(free_screening_admin_controller_1.ensureScreeningTemplateDefaultAdminController));
router.put('/screening/templates/:templateId', auth_middleware_1.requireAuth, (0, rbac_middleware_1.requireRole)('admin'), (0, rbac_middleware_1.requireAdminPolicy)('screening.manage'), (0, validate_middleware_1.asyncHandler)(free_screening_admin_controller_1.updateScreeningTemplateAdminController));
router.get('/screening/templates/:templateId/questions', auth_middleware_1.requireAuth, (0, rbac_middleware_1.requireRole)('admin'), (0, rbac_middleware_1.requireAdminPolicy)('screening.manage'), (0, validate_middleware_1.asyncHandler)(free_screening_admin_controller_1.listTemplateQuestionsAdminController));
router.post('/screening/templates/:templateId/questions', auth_middleware_1.requireAuth, (0, rbac_middleware_1.requireRole)('admin'), (0, rbac_middleware_1.requireAdminPolicy)('screening.manage'), (0, validate_middleware_1.asyncHandler)(free_screening_admin_controller_1.createTemplateQuestionAdminController));
router.put('/screening/questions/:questionId', auth_middleware_1.requireAuth, (0, rbac_middleware_1.requireRole)('admin'), (0, rbac_middleware_1.requireAdminPolicy)('screening.manage'), (0, validate_middleware_1.asyncHandler)(free_screening_admin_controller_1.updateTemplateQuestionAdminController));
router.post('/screening/questions/:questionId/options', auth_middleware_1.requireAuth, (0, rbac_middleware_1.requireRole)('admin'), (0, rbac_middleware_1.requireAdminPolicy)('screening.manage'), (0, validate_middleware_1.asyncHandler)(free_screening_admin_controller_1.createQuestionOptionAdminController));
router.put('/screening/options/:optionId', auth_middleware_1.requireAuth, (0, rbac_middleware_1.requireRole)('admin'), (0, rbac_middleware_1.requireAdminPolicy)('screening.manage'), (0, validate_middleware_1.asyncHandler)(free_screening_admin_controller_1.updateQuestionOptionAdminController));
router.get('/screening/templates/:templateId/scoring-bands', auth_middleware_1.requireAuth, (0, rbac_middleware_1.requireRole)('admin'), (0, rbac_middleware_1.requireAdminPolicy)('screening.manage'), (0, validate_middleware_1.asyncHandler)(free_screening_admin_controller_1.listScoringBandsAdminController));
router.put('/screening/templates/:templateId/scoring-bands', auth_middleware_1.requireAuth, (0, rbac_middleware_1.requireRole)('admin'), (0, rbac_middleware_1.requireAdminPolicy)('screening.manage'), (0, validate_middleware_1.asyncHandler)(free_screening_admin_controller_1.replaceScoringBandsAdminController));
router.post('/screening/templates/:templateId/simulate', auth_middleware_1.requireAuth, (0, rbac_middleware_1.requireRole)('admin'), (0, rbac_middleware_1.requireAdminPolicy)('screening.manage'), (0, validate_middleware_1.asyncHandler)(free_screening_admin_controller_1.simulateTemplateScoringController));
router.get('/screening/provider-questions', auth_middleware_1.requireAuth, (0, rbac_middleware_1.requireRole)('admin'), (0, rbac_middleware_1.requireAdminPolicy)('screening.manage'), (0, validate_middleware_1.asyncHandler)(free_screening_admin_controller_1.listAllProviderExtraQuestionsAdminController));
/**
