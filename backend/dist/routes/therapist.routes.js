...
router.post('/session/:id/generate-ai-note', auth_middleware_1.requireAuth, rbac_middleware_1.requireTherapistRole, ...validate_middleware_1.validateSessionIdParam, (0, validate_middleware_1.asyncHandler)(therapist_modules_controller_1.postGenerateAiSessionNoteController));
