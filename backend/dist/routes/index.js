...
const institutional_agreement_routes_1 = __importDefault(require("./institutional-agreement.routes"));
...
router.use('/v1/therapist', free_screening_provider_routes_1.default);
router.use('/v1/admin', admin_routes_1.default);
// Mount admin-facing free-screening endpoints under admin namespace
router.use('/v1/admin', free_screening_admin_routes_1.default);
...
router.use('/api/q', qr_routes_1.default);
router.use('/q', qr_routes_1.default);
